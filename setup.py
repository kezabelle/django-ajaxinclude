...
DEVELOP_REQUIREMENTS = tidy_requirements(os.path.join(BASE_DIR,
...
setup(
    ...
    url='https://github.com/kezabelle/django-ajaxinclude/tree/master',
    packages=PACKAGES,
    install_requires=REQUIREMENTS + DEVELOP_REQUIREMENTS,
